...
<br><br><br>
          ...
          while ($row = mysqli_fetch_assoc($select_user_orders)) {
            ...
            $travellingdate = $row['time'];
            $travellingdate = explode(" ", $travellingdate);
            ...
            <table class="table table-striped" style="width: 50%">
              <tbody>
                ...
                <tr>
                  <td><b>Date Of Booking: </b></td>
                  <td><?php echo $travellingdate[0]; ?></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    function cancel(){
                      ...
                      <button class="btn btn-primary btn-xs" name="cancel" onClick="cancel();">Cancel</button></td>
                    </form>
                </tr>
                <br><br><br>
                <tr>
                  <td><b>Adjustment of Ticket<b></td>
                  
                  <td>
                    <form action="adjust.php?orderid=<?php echo $orderid ?>&bus_id=<?php echo $busid ?>" method="post">
                    <script>
                    function adjust(){
                      if(confirm("Are you sure to adjust the Ticket?")){
                      
                      }
                    }
                  </script>
                      <button class="btn btn-primary btn-xs" name="adjust" onClick="adjust();">Adjustment of Ticket</button></td>
                    </form>
                </tr>
                <br><br><br>
              </tbody>
        ...
        <div id="Edit Details" class="tabcontent">
          ...
          <?php
            ...
            if ($username=="" || $user_firstname=="" || $user_lastname=="" || $user_email=="" || $user_phoneno=="" || $user_password=="") {
                echo "**ALL FIELDS MANDATORY";
              }
              elseif (strlen($user_phoneno)!=10) {
            ...
            <form action="" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input value="<?php echo $user_phoneno; ?>" type="text" class="form-control" name="user_phoneno"  pattern="[123456789][0-9]{9}" title="Please enter valid phone number" autocomplete="on" required >
              </div>
