            ...
            <div class="col-md-8">
                ...
                <?php 
                    ...
                    while($row = mysqli_fetch_assoc($select_all_bus_query)) {
                      ...
                      $bus_times = explode(" ",$times);
                        ...
                        <p><span class="glyphicon glyphicon-time"></span> Bus available from: <?php echo $bus_date; ?></p>
                        <hr>
                        ...
                        <div class="jumbotron jumb">
                            <h4><b>Seat Available: <?php echo $available_seats; ?> </b></h4>
                            <h4>Max:         <?php echo $max_seats; ?></h4>
                            <!-- <h5>Available:   <?php echo $available_seats ?></h5> -->


                            <h4><b>Stations Covered:</b></h4>
                        ...
                        <div class="jumbotron">
                            <div class="container-fluid">
                                ...
                                <button class="btn btn-primary" name="book" style="margin-left: 40%; margin-top: 15px;">Book Now </button>
                                ...
                                if (isset($_POST['book'])) {
                                    ...
                                    for ($i=0; $i < $count; $i++) { 
                                        ...
                                        $query = "INSERT INTO orders(bus_id, user_id, user_name, user_age, source, destination,date,cost, time) VALUES($selected_bus, $user_id , '$curr_name', '$curr_age', '$source', '$destination', '$bus_date', $cost, current_timestamp())";
                ...
                <div class="well">
                    ...
                    <form action="bus_info.php?bus_id=<?php echo $selected_bus ?>" method="post" role="form">
                        ...
                        <button type="submit" class="btn btn-primary" name="submit_query">Submit My Feedback</button>
                    </form>
                </div>
